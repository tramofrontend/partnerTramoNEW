...
export default React.memo(function GSTVerification() {
        ...
        <Scrollbar>
          <Grid display={'grid'} gridTemplateColumns={'repeat(6, 1fr)'} gap={1} my={1}>
            ...
            >
              ...
              <MenuItem value="gst_number">GST Number</MenuItem>
            </RHFSelect>
            ...
            {watch('searchBy') == 'gst_number' && <RHFTextField name="key2" label="GST Number" />}
