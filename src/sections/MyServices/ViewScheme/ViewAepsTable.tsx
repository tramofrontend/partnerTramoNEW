...
export default function ViewAepsTable({ title, subheader, tableData, comData, ...other }: Props) {
  const tableLabels = [
    { id: 'min', label: 'Min. Slab' },
    { id: 'max', label: 'Max. Slab' },
    { id: 'txn', label: 'Transaction Type' },
    { id: 'commissionT', label: 'Commission Type' },
  ...
  return (
    <>
      <TableRow>
        ...
        <TableCell>
          {row.commissionType == 'flat' ? 'Rs.' : row.commissionType == 'percentage' ? '%' : '-'}
        </TableCell>
